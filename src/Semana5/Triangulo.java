...
public class Triangulo{
    ...
    Triangulo(float base, float altura, float hipotenusa){
        this.set(base, altura, hipotenusa);
    }

    //set base, altura, hipotenusa, area, perimetro
    public void set(float lado1, float lado2, float lado3){
    ...
    public Boolean equals(Triangulo triangulo1, Triangulo triangulo2){
        ...
        System.out.println("Área: "+triangulo1.getArea());
        ...
        System.out.println("Área: "+triangulo2.getArea());
        System.out.println("Perímetro: "+triangulo2.getPerimetro());
        System.out.println("Lados: "+triangulo2.getLados()+"\n");
        return(triangulo1.getLados()==triangulo2.getLados());
    }
}