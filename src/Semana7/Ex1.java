...
public class Ex1 {
    public static void main(String[] args){
        ...
        Circulo circulo2 = new Circulo(3, "vermelho");
        Retangulo retangulo1 = new Retangulo(3, 3, "azul");
        Retangulo retangulo2 = new Retangulo(3, 3, "vermelho");
        Triangulo triangulo1 = new Triangulo(3, 3, 3, "azul");
        Triangulo triangulo2 = new Triangulo(3, 3, 3, "vermelho");
    ...
    public static void criarCirculos(Scanner sc, Circulo circulo1,Circulo circulo2){
        ...
        while(cor1==""){
            System.out.println("Insira a cor do circulo1:");
            cor1 = sc.next();
        }
    ...
    private static void criarRetangulos(Scanner sc, Retangulo retangulo1, Retangulo retangulo2){
        ...
        while(cor1==""){
            System.out.println("Insira a cor do Retângulo1:");
            cor1 = sc.next();
        }
        ...
        retangulo1.set(comprimento1, altura1, cor1);
        ...
        retangulo2.set(comprimento2, altura2, cor2);
    }
    ...
    private static void criarTriangulos(Scanner sc, Triangulo triangulo1, Triangulo triangulo2){
        ...
        triangulo1.set(base1, altura1, hipotenusa1, cor1);
        ...
        triangulo2.set(base2, altura2, hipotenusa2, cor2);
    }
